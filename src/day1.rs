...
fn parse_line2(line: &str) -> i64 {
    ...
    for ch in iter {
        match ch.to_digit(10) {
            None => {
                let num = parse_letters(line, index);
...
fn parse_letters(line: &str, index: usize) -> i64 {
    let word: &str = &line[index..];
...
const INPUTF: &str = "twovgtprdzcjjzkq3ffsbcblnpq
